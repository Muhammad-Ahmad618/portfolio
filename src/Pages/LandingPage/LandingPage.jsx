        ...
        <div className="py-28 sm:py-0 font-primary flex items-start lg:items-center flex-col lg:flex-row gap-y-10 lg:gap-x-20 min-h-screen">
          <div className="text-white font-bold text-[2.5rem] sm:text-[3rem] w-full basis-[100%] lg:basis-[45%]">
            ...
            <Fade direction="up" triggerOnce={true} duration={1500}>
              <h3 className="text-base sm:text-[1.1rem] font-medium py-3">
                Skilled in React.js | Tailwind CSS | UI/UX Design.
              </h3>
            </Fade>
            ...
            <div className="my-5 flex flex-wrap w-full gap-y-5 min-[400px]:gap-x-5">
              <div className="bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 p-1 rounded-xl flex max-w-[10rem] w-full">
                <button
                  className="bg-[#161515] flex items-center justify-center gap-x-2 text-base font-medium rounded-lg w-full cursor-pointer py-2.5 hover:bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500"
                  onClick={() => handleClick()}
                >
                  <FaGithub className="text-[1.4rem]" /> Learn More
                </button>
              </div>
          ...
          <div className="basis-[100%] lg:basis-[45%] w-full ">
            ...
            <div className="bg-gray-900 p-5 rounded-b-xl overflow-hidden">
              <ProfileCode />
            </div>
          </div>
        </div>
