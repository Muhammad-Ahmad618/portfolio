  ...
  return (
    <div className='max-w-screen-2xl mx-auto px-5 md:px-20 my-28 md:my-20'>
      ...
      <GradientText
       ...
       <div className='flex justify-between flex-wrap items-center gap-y-10 md:gap-x-16 mt-5 md:mt-20'>

        <div className='text-white basis-[100%] lg:basis-[45%] w-full text-center md:text-start'>
          <h3 className='text-[1.4rem] md:text-[1.8rem] pb-10 font-semibold bg-gradient-to-r from-purple-500 to-red-600 bg-clip-text text-transparent'>Have any Question or Wanna Work Together ? Drop me a Message</h3>
